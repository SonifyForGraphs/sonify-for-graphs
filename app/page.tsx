      ...
      <section className='flex flex-col items-center justify-center bg-gray-100 py-20'>
        <div className='text-center max-w-2xl'>
          <h2 className='text-4xl font-extrabold mb-4'>
            Convert Data Into Sound with Soundviz
          </h2>
          <p className='text-gray-700 text-lg mb-6'>
            Upload your graphs or data, choose your sonification preferences,
        ...
        <div className='mt-12'>
          <Image
            src='/images/sonification-example.png'
            alt='Sonification Example'
            width={600}
            height={400}
          />
        </div>
      ...
      <section className='container mx-auto py-16 grid grid-cols-1 md:grid-cols-3 gap-8'>
        <div className='bg-white p-6 rounded shadow text-center'>
          ...
          <p className='text-gray-600'>
            Easily upload your graph images or datasets. We support multiple
        ...
        <div className='bg-white p-6 rounded shadow text-center'>
          ...
          <p className='text-gray-600'>
            Select from a variety of sonification styles, including &quot;Left
            to Right&quot;, &quot;Expanding Circles&quot;, and more.
          </p>
        </div>
        <div className='bg-white p-6 rounded shadow text-center'>
          <h3 className='text-2xl font-bold mb-4'>Download & Share</h3>
          <p className='text-gray-600'>
            After sonifying your data, download the audio file or share it
